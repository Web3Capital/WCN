  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Regional Nodes</T></h1>
        <p className="muted"><T>Regional level nodes in the network.</T></p>

        <div className="mt-14">
          {nodes.length === 0 ? (
            <p className="muted"><T>No regional nodes found.</T></p>
          ) : (
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
                <thead>
                  <tr style={{ borderBottom: "1px solid var(--border)" }}>
                    ...
                    <th style={{ textAlign: "left", padding: "0.75rem" }}><T>Region</T></th>
                ...
                <tbody>
                  {nodes.map((node) => (
                    <tr key={node.id} style={{ borderBottom: "1px solid var(--border)" }}>
                      ...
                      <td style={{ padding: "0.75rem" }}>{node.region || "—"}</td>
