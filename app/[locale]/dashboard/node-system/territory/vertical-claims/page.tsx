...
export const metadata = dashboardMeta("Vertical Claims", "View vertical territory claims");

export default async function VerticalClaimsPage() {
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <p className="muted">
          <T>Industry/vertical territory claims in the network.</T>
        </p>

        <div className="mt-14">
          {territories.length === 0 ? (
            <p className="muted">
              <T>No vertical claims found</T>
            </p>
          ) : (
