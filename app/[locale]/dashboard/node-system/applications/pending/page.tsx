...
export const metadata = dashboardMeta("Pending Applications", "Review pending node applications");
    ...
    return (
      <div className="dashboard-page section">
        <div className="container-wide">
          ...
          <h1><T>Pending Applications</T></h1>
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Pending Applications</T></h1>
        <p className="muted">
          <T>New applications awaiting initial review</T>
        </p>
        ...
        <div className="card mt-18">
          {applications.length === 0 ? (
            <div style={{ padding: "24px 16px" }}>
              <p className="muted" style={{ margin: 0 }}>
                <T>No pending applications at this time.</T>
              </p>
