...
export const metadata = dashboardMeta("Rejected Applications", "Review rejected node applications");
    ...
    return (
      <div className="dashboard-page section">
        <div className="container-wide">
          ...
          <h1><T>Rejected Applications</T></h1>
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Rejected Applications</T></h1>
        <p className="muted">
          <T>Applications that did not meet criteria or were declined</T>
        </p>
        ...
        <div className="card mt-18">
          {applications.length === 0 ? (
            <div style={{ padding: "24px 16px" }}>
              <p className="muted" style={{ margin: 0 }}>
                <T>No rejected applications at this time.</T>
              </p>
                  ...
                  <tbody>
                    {applications.map((app) => (
                      <tr key={app.id}>
                        ...
                        <td style={{ paddingLeft: 16, fontSize: "0.875rem" }}>
                          <span className="muted">{formatDate(app.updatedAt)}</span>
                        </td>
