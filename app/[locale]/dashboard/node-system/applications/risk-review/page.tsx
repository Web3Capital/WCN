...
export const metadata = dashboardMeta("Risk Review", "Applications under risk assessment");
...
export default async function RiskReviewApplicationsPage() {
  ...
  // Risk review applications are part of REVIEWING status
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Risk Review</T></h1>
        <p className="muted">
          <T>Applications undergoing risk assessment and compliance review</T>
        </p>
