...
export const metadata = dashboardMeta("Approved Applications", "Review approved node applications");
    ...
    return (
      <div className="dashboard-page section">
        <div className="container-wide">
          ...
          <h1><T>Approved Applications</T></h1>
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Approved Applications</T></h1>
        <p className="muted">
          <T>Applications approved and ready for onboarding</T>
        </p>
        ...
        <div className="card mt-18">
          {applications.length === 0 ? (
            <div style={{ padding: "24px 16px" }}>
              <p className="muted" style={{ margin: 0 }}>
                <T>No approved applications at this time.</T>
              </p>
