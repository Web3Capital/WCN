...
export const metadata = dashboardMeta("Info Needed", "Applications requiring more information");
...
export default async function InfoNeededApplicationsPage() {
  ...
  // Info-needed applications are part of REVIEWING status
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Info Needed</T></h1>
        <p className="muted">
          <T>Applications requiring additional information or clarification</T>
        </p>
