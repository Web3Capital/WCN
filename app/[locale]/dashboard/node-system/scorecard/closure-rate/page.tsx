...
export const metadata = dashboardMeta("Closure Rate", "Node scorecard dimension");

export default async function ClosureRatePage() {
  ...
  const avgScore =
    scorecards.length > 0
      ? scorecards.reduce((sum, sc) => sum + sc.closureScore, 0) / scorecards.length
      : 0;
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Closure Rate</T></h1>
        <p className="muted"><T>Deal closure rate performance ranking.</T></p>
                ...
                <tbody>
                  {scorecards.map((sc, idx) => (
                    <tr key={sc.id}>
                      ...
                      <td className="font-bold">{sc.closureScore.toFixed(1)}</td>
