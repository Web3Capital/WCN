...
export const metadata = dashboardMeta("Risk Record", "Node scorecard dimension");

export default async function RiskRecordPage() {
  ...
  const avgScore =
    scorecards.length > 0
      ? scorecards.reduce((sum, sc) => sum + sc.riskScore, 0) / scorecards.length
      : 0;
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Risk Record</T></h1>
        <p className="muted"><T>Compliance and risk scores.</T></p>
                ...
                <tbody>
                  {scorecards.map((sc, idx) => (
                    <tr key={sc.id}>
                      ...
                      <td className="font-bold">{sc.riskScore.toFixed(1)}</td>
