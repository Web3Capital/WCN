...
export const metadata = dashboardMeta("Quarterly Scorecards", "Q-period evaluation");
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Quarterly Evaluation</T></h1>
        <p className="muted"><T>Quarterly scorecard records.</T></p>
        ...
        <div className="card mt-14">
          {scorecards.length === 0 ? (
            <p className="muted text-center py-20"><T>No quarterly scorecard records found.</T></p>
          ) : (
