...
export const metadata = dashboardMeta("Collaboration Reliability", "Node scorecard dimension");
...
export default async function CollaborationPage() {
  ...
  const avgScore =
    scorecards.length > 0
      ? scorecards.reduce((sum, sc) => sum + sc.collaborationScore, 0) / scorecards.length
      : 0;
  ...
  return (
    <div className="dashboard-page section">
      <div className="container-wide">
        ...
        <h1><T>Collaboration Reliability</T></h1>
        <p className="muted"><T>Response speed and reliability scores.</T></p>
                ...
                <tbody>
                  {scorecards.map((sc, idx) => (
                    <tr key={sc.id}>
                      ...
                      <td className="font-bold">{sc.collaborationScore.toFixed(1)}</td>
